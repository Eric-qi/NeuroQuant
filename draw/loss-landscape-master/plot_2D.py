...
def plot_2d_contour(surf_file, surf_name='train_loss', vmin=0.1, vmax=10, vlevel=0.5, show=False):
    ...
    # ax.set_title("3D Surface Plot", fontsize=12, fontproperties=font_prop)
    ax.set_xlabel(r"$\Delta w_2$", fontsize=12, fontproperties=font_prop)
    ax.set_ylabel(r"$\Delta w_1$", fontsize=12, fontproperties=font_prop, labelpad=10)
